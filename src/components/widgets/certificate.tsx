...
const Certificate: FC<{
  ...
  return (
    <Link href={href} target="_blank">
      <div className="relative max-w-[300px] h-[320px] w-full bg-gray-100 dark:bg-gray-800 rounded-lg flex flex-col items-end overflow-hidden group cursor-pointer">
        ...
        <div className="absolute w-[150px] h-[150px] transition ease-in-out group-hover:-translate-y-1 group-hover:scale-110 duration-100 bottom-0 -z-0">
          <Image
            src={imageSrc}
            fill
            alt="featured"
